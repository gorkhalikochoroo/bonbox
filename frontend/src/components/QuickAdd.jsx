  ...
  return (
    <>
      <button
        ...
        className={`fixed bottom-6 right-6 z-40 w-14 h-14 ${mode === "personal" ? "bg-purple-600 hover:bg-purple-700" : "bg-blue-600 hover:bg-blue-700"} text-white rounded-full shadow-lg hover:scale-105 transition-all flex items-center justify-center text-3xl font-light`}
      >
        +
      </button>
