      ...
      {denying && (
        <div className="space-y-2 border-t border-blue-100 dark:border-blue-900/20 pt-2">
          <textarea
            ...
            className="w-full px-2 py-1.5 rounded-md border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-800 text-xs text-gray-800 dark:text-gray-100 outline-none focus:border-blue-400 resize-none"
          />
