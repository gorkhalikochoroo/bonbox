...
const translations = {
  en: {
    ...
    landingStatLanguages: "Languages", landingStatPrice: "Price",
    landingFeaturesTag: "Built for you", landingFeaturesTitle: "One app. Every business need.",
    landingFeaturesSub: "Restaurant, bar, grocery, salon, bakery, food truck, thrift store — BonBox has you covered.",
  ...
  da: {
    ...
    landingStatLanguages: "Sprog", landingStatPrice: "Pris",
  ...
  np: {
    ...
    landingStatLanguages: "भाषाहरू", landingStatPrice: "मूल्य",
