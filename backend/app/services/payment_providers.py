...
PROVIDERS = {
    "vipps_mobilepay": {
        ...
        "countries": ["DK", "NO"],
        "description": "Auto-import your MobilePay and Vipps sales",
        "logo_emoji": "📱",
        "setup_time": "5 min",
        "portal_url": "https://portal.vippsmobilepay.com",
        "portal_name": "Vipps MobilePay Portal",
        "setup_steps": [
            "Log in to portal.vippsmobilepay.com with your business account",
            "Go to 'Developer' section in the left menu",
            "Find your API keys — you need the 4 values below",
            "Copy-paste them here. BonBox will test the connection before saving.",
        ],
        "fields": [
            {
                "key": "merchant_serial",
                "label": "Merchant Number (MSN)",
                "type": "text",
                "placeholder": "e.g. 123456",
                "help": "Your shop number — shown at the top of the portal dashboard",
            },
            {
                "key": "client_id",
                "label": "Client ID",
                ...
                "help": "Found under Developer > API keys in the portal",
            },
            {
                "key": "client_secret",
                "label": "Client Secret",
                ...
                "help": "The secret key paired with your Client ID",
            },
            {
                ...
                "help": "Listed as 'Ocp-Apim-Subscription-Key' in the portal",
            },
        ],
    },
    "esewa": {
        "name": "eSewa",
        "countries": ["NP"],
        "description": "Auto-import your eSewa merchant sales",
        "logo_emoji": "💚",
        "setup_time": "3 min",
        "portal_url": "https://merchant.esewa.com.np",
        "portal_name": "eSewa Merchant Portal",
        "setup_steps": [
            "Log in to your eSewa merchant account",
        ...
        "fields": [
            {
                ...
                "help": "Your unique merchant identifier from eSewa",
            },
            {
                "key": "api_key",
                "label": "API Key",
                ...
                "help": "Found in the API/integration settings of your merchant panel",
            },
        ],
    },
    "khalti": {
        "name": "Khalti",
        "countries": ["NP"],
        "description": "Auto-import your Khalti merchant sales",
        "logo_emoji": "💜",
        "setup_time": "2 min",
        "portal_url": "https://admin.khalti.com",
        "portal_name": "Khalti Merchant Dashboard",
        "setup_steps": [
            "Log in to admin.khalti.com",
            "Go to Settings > Keys",
            "Copy your Secret Key (starts with 'live_secret_key_...')",
        ],
        "fields": [
            {
                "key": "secret_key",
                ...
                "help": "Found under Settings > Keys in the Khalti dashboard",
            },
        ],
    },
}
