...
EMOJI_BASELINE=358  # true count 2026-07-02 (AgentDataCards ⚠️🎯✅💡📊 → Lucide); top offenders: CompetitorPage 42, WineListPage 39, InventoryPage 24, MultiTerminalClose 21, WeatherPage 20
