...
export default function NavV2() {
  ...
  return (
    <header className="sticky top-0 z-30 border-b border-slate-200 bg-slate-50/[0.88] backdrop-blur-[14px]">
      <div className="mx-auto flex h-[66px] max-w-[1180px] items-center gap-9 px-[clamp(24px,4vw,64px)]">
      ...
      >
        <nav
          aria-label={t("landingV2.nav.sections", "Sections")}
          className="mx-auto flex max-w-[1180px] flex-col px-[clamp(24px,4vw,64px)] py-2"
        >
          {links.map((l) => (
            <a
              key={l.href}
