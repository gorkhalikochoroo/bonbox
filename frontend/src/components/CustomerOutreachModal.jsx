        ...
        <div className="overflow-y-auto flex-1">
          ...
          <div className="px-5 pt-4 pb-2">
            ...
            <textarea
              ...
              className="w-full px-3 py-2 border border-stone-200 dark:border-stone-700 bg-white dark:bg-stone-800 text-stone-800 dark:text-stone-100 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 leading-relaxed"
            />
